...
class Intro extends Component {
  constructor(props) {
    ...
    this.state = {
      showButton: false,
      pngs: [
        require('../../assets/images/slider/s1.png'),
        require('../../assets/images/slider/s2.png'),
        require('../../assets/images/slider/s3.png'),
        require('../../assets/images/slider/s4.png'),
        require('../../assets/images/slider/s5.png'),
      ],
    };
  }
