...
const readMenuPng = require('../../../assets/images/read_menu.png');
const readGoldPng = require('../../../assets/images/read_gold.png');
        ...
        <Provider>
          <View style={{marginTop: 10, backgroundColor: '#fff'}}>
            <View style={{paddingLeft: 20, paddingRight: 20}}>
              <TouchableOpacity
                activeOpacity={1}
                onPress={() => this._permissionDescription()}>
                <View
                  style={{
                    paddingTop: 15,
                    paddingBottom: 15,
          ...
          <View style={{marginTop: 10, backgroundColor: '#fff'}}>
            <View style={{paddingLeft: 20, paddingRight: 20}}>
              ...
              <TouchableOpacity
                activeOpacity={1}
                onPress={() => this.goTarget('Nickname')}>
                <View
                  style={{
                    paddingTop: 15,
                    paddingBottom: 15,
