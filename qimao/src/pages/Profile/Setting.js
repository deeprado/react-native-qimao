        ...
        <View style={styles.container}>
          ...
          <View style={{marginTop: 10, backgroundColor: '#fff'}}>
            <View style={{paddingLeft: 20, paddingRight: 20}}>
              ...
              <TouchableOpacity
                activeOpacity={1}
                onPress={() => this.goTarget('AccountSafe')}>
                <View
                  style={{
                    flexDirection: 'row',
                    justifyContent: 'space-between',
              ...
              <TouchableOpacity
                activeOpacity={1}
                onPress={() => this.goTarget('ReadSetting')}>
                <View
                  style={{
                    flexDirection: 'row',
                    justifyContent: 'space-between',
              ...
              <TouchableOpacity
                activeOpacity={1}
                onPress={() => this.goTarget('CacheClear')}>
                <View
                  style={{
                    flexDirection: 'row',
                    justifyContent: 'space-between',
          ...
          <View
            ...
            <TouchableOpacity activeOpacity={1} onPress={this.onLogoutShow}>
          ...
          <View style={{marginTop: 80}}>
            <View
              ...
              <TouchableOpacity activeOpacity={1} onPress={() => this.goTarget('Privacy')}>
                <Text style={{color: '#FDA63B'}}>《隐私政策》</Text>
              </TouchableOpacity>
              <TouchableOpacity activeOpacity={1} onPress={() => this.goTarget('Agreement')}>
                <Text style={{color: '#FDA63B'}}>《用户协议》</Text>
              </TouchableOpacity>
              <TouchableOpacity activeOpacity={1} onPress={() => this.goTarget('Copyright')}>
                <Text style={{color: '#FDA63B'}}>《版权声明》</Text>
              </TouchableOpacity>
              <TouchableOpacity activeOpacity={1} onPress={() => this.goTarget('Permission')}>
