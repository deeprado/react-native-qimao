...
const welfareReadPng = require('../../assets/images/welfare_read.png');
    ...
    return (
      <View
        ...
        <View
          ...
          <TouchableOpacity
            activeOpacity={1}
            onPress={() => this.goTarget('DepotBox')}>
        ...
        <ScrollView
          ...
          <View
            ...
            <View
              ...
              <TouchableOpacity
                activeOpacity={1}
                onPress={() => this.goTarget('Download')}>
                <View style={styles.operBtn}>
