...
const wechatLoginPng = require('../../assets/images/wechat_login.png');
      ...
      <View style={styles.container}>
        ...
        <View style={{paddingLeft: 30, paddingRight: 30}}>
          ...
          <View
            ...
            <TouchableOpacity activeOpacity={1} onPress={this._onLogin}>
              <View
                style={{
                  flexDirection: 'row',
                  justifyContent: 'center',
