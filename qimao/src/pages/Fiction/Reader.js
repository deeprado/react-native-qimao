...
import * as ReaderUtil from '../../utils/reader';
// import Request from '../../lib/request';
import Battery from '../../components/Battery';

const logoPng = require('../../assets/images/logo.png');
const backPng = require('../../assets/images/back.png');
...
class Reader extends Component {
  ...
  //           let _arr = ReaderUtil.handleContent(content);
  ...
  //             _arr = ReaderUtil.handleContent(content);
  ...
  getContent = chapterInfo => {
    ...
    let _arr = ReaderUtil.handleContent(_content);
        ...
        <View style={styles.alertTop}>
          <View style={{flexDirection: 'row', alignItems: 'center'}}>
            <TouchableOpacity
              ...
              <Image style={styles.backImg} source={backPng} />
