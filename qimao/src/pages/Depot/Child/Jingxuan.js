...
const categoryPng = require('../../../assets/images/category.png');
const rankPng = require('../../../assets/images/rank.png');
const newPng = require('../../../assets/images/new.png');
...
class Jingxuan extends Component {
  ...
  _renderSpecialItem = row => {
    let item = row.item;
    return (
      <TouchableOpacity activeOpacity={1} key={item.id * 5}>
        <View
          style={{
            marginBottom: 20,
            flexDirection: 'row',
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        <View style={styles.container}>
          ...
          <View style={styles.navBox}>
            <TouchableOpacity
              activeOpacity={1}
              onPress={() => this.goTarget('Category')}>
